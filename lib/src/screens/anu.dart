...
class Anu extends StatefulWidget {
  const Anu({Key? key}) : super(key: key);
                      ...
                      child: Column(
                        children: [
                          Row(
                            children: const [
                              SizedBox(width: 50,),
                              Text("29-Dec-2021" , style: TextStyle(
                                fontWeight: FontWeight.w400,
                                fontSize: 22,
                                color: Color.fromRGBO(101, 98, 98, 1)
                              ),),
                              SizedBox(width: 60,),
                              Text("9:02 PM" , style: TextStyle(
                                  fontWeight: FontWeight.w400,
                                  fontSize: 22,
                                  color: Color.fromRGBO(101, 98, 98, 1)),),
                              SizedBox(width: 50,),
                          ...
                          Row(
                            children: [
                              ...
                              Column(
                                children: [
                                  SizedBox(height: 10,),
                                  const Text("12 C" ,style: TextStyle(
                                    fontSize: 37,
                                    fontWeight: FontWeight.w400,
                                      color: Color.fromRGBO(0, 0, 0, 1),
                                  ),),
                                  const Text("Thunderstorms",style: TextStyle(
                                    fontSize: 20,
                                    fontWeight: FontWeight.w400,
                ...
                Container(
                  ...
                  width: 382,
                    child:  Card(
                      ...
                      children: [
                        SizedBox(width: 15,),
                            Icon(Icons.wb_cloudy_rounded , color: Colors.cyanAccent,),
                        SizedBox(width: 15,),
                            Column(
                              children: const [
                                SizedBox(height: 15,),
                                Text("AQI" , style: TextStyle(
                                  fontWeight: FontWeight.w500,
                                  fontSize: 20,
                                )),
                                SizedBox(height: 15,),
                                Text("70 | LOW" ,style: TextStyle(
                                  fontWeight: FontWeight.w400,
                                  fontSize: 15,
                                )),
                              ],
                        ...
                        SizedBox(width: 115,),
                           const Icon(Icons.wb_cloudy_rounded, color: Colors.cyanAccent,),
                        Column(
                          children: const [
                            ...
                            Text("1015 mbar", style: TextStyle(
                              fontWeight: FontWeight.w400,
                              fontSize: 20,
                            )),
                          ],
